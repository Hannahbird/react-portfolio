...
function Footer() {
    return (
        <div className='bg-dark d-flex justify-content-center fixed-bottom p-0'>
            <a className='me-2 my-2' href='https://github.com/HannahBird/' target='_blank' rel='noreferrer'>
                <img  src={github} alt='GitHub logo' height='64px'></img>
            </a>
            <a className='me-2 my-2' href='https://www.linkedin.com/in/hannah-brownson-b5a52823b/' target='_blank' rel='noreferrer'>
                <img  src={linkedIn} className="primary" alt='LinkedIn logo' height='64px'></img>
            </a>
            <a className='my-2' href='https://instagram.com/hannah_brownson/' target='_blank' rel='noreferrer'>
